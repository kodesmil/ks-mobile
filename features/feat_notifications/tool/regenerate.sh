...
if [ ! -d "$NOTIFICATIONSAPIS" ]; then
  echo "Please set the $NOTIFICATIONSAPIS environment variable to your clone of go_notifications"
  exit -1
fi

PROTOC="protoc --dart_out=grpc:lib/src/generated -I$PROTOBUF/src -I$GOOGLEAPIS -I$NOTIFICATIONSAPIS"
...
$PROTOC $NOTIFICATIONSAPIS/notification.proto
