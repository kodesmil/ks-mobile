...
mixin _$ServiceInPersonStore on _ServiceInPersonStore, Store {
  final _$servicesAtom = Atom(name: '_ServiceInPersonStore.services');
  ...
  final _$fetchAsyncAction = AsyncAction('_ServiceInPersonStore.fetch');
