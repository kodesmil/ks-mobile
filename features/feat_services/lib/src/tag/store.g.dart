...
mixin _$ServiceTagStore on _ServiceTagStore, Store {
  final _$servicesAtom = Atom(name: '_ServiceTagStore.services');
  ...
  final _$fetchAsyncAction = AsyncAction('_ServiceTagStore.fetch');
