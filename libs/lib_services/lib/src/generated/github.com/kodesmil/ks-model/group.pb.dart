...
class Group extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Group', package: const $pb.PackageName('model'), createEmptyInstance: create)
    ...
    ..aOS(2, 'name')
    ..aOS(3, 'notes')
    ..aOM<$6.Identifier>(4, 'profileId', subBuilder: $6.Identifier.create)
  ...
  @$pb.TagNumber(4)
  $6.Identifier get profileId => $_getN(3);
  @$pb.TagNumber(4)
  set profileId($6.Identifier v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasProfileId() => $_has(3);
  @$pb.TagNumber(4)
  void clearProfileId() => clearField(4);
  @$pb.TagNumber(4)
  $6.Identifier ensureProfileId() => $_ensure(3);
}
