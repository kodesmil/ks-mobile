...
//  source: github.com/infobloxopen/protoc-gen-gorm/types/types.proto
//
// @dart = 2.3
...
class UUIDValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UUIDValue', package: const $pb.PackageName('gorm.types'), createEmptyInstance: create)
    ..aOS(1, 'value')
  ...
  factory UUIDValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UUIDValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  UUIDValue clone() => UUIDValue()..mergeFromMessage(this);
  UUIDValue copyWith(void Function(UUIDValue) updates) => super.copyWith((message) => updates(message as UUIDValue));
  ...
  @$core.pragma('dart2js:noInline')
  static UUIDValue getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UUIDValue>(create);
...
class JSONValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('JSONValue', package: const $pb.PackageName('gorm.types'), createEmptyInstance: create)
    ..aOS(1, 'value')
    ..hasRequiredFields = false
  ;
  ...
  JSONValue copyWith(void Function(JSONValue) updates) => super.copyWith((message) => updates(message as JSONValue));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UUID extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UUID', package: const $pb.PackageName('gorm.types'), createEmptyInstance: create)
    ..aOS(1, 'value')
    ..hasRequiredFields = false
  ;
...
class InetValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InetValue', package: const $pb.PackageName('gorm.types'), createEmptyInstance: create)
    ..aOS(1, 'value')
    ..hasRequiredFields = false
  ;
  ...
  factory InetValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InetValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  InetValue clone() => InetValue()..mergeFromMessage(this);
  InetValue copyWith(void Function(InetValue) updates) => super.copyWith((message) => updates(message as InetValue));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static InetValue getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InetValue>(create);
...
class TimeOnly extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimeOnly', package: const $pb.PackageName('gorm.types'), createEmptyInstance: create)
  ...
  factory TimeOnly.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TimeOnly.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  TimeOnly clone() => TimeOnly()..mergeFromMessage(this);
  TimeOnly copyWith(void Function(TimeOnly) updates) => super.copyWith((message) => updates(message as TimeOnly));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TimeOnly getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TimeOnly>(create);
