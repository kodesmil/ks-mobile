...
class SortCriteria_Order extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, SortCriteria_Order> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class LogicalOperator_Type extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, LogicalOperator_Type> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class StringCondition_Type extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, StringCondition_Type> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class NumberCondition_Type extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, NumberCondition_Type> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class StringArrayCondition_Type extends $pb.ProtobufEnum {
  static const StringArrayCondition_Type IN = StringArrayCondition_Type._(0, 'IN');

  static const $core.List<StringArrayCondition_Type> values = <StringArrayCondition_Type> [
    IN,
  ];

  static final $core.Map<$core.int, StringArrayCondition_Type> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class NumberArrayCondition_Type extends $pb.ProtobufEnum {
  static const NumberArrayCondition_Type IN = NumberArrayCondition_Type._(0, 'IN');

  static const $core.List<NumberArrayCondition_Type> values = <NumberArrayCondition_Type> [
    IN,
  ];

  static final $core.Map<$core.int, NumberArrayCondition_Type> _byValue = $pb.ProtobufEnum.initByValue(values);
