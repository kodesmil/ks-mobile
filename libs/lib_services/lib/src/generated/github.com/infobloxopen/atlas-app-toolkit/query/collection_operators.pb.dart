...
class SortCriteria extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SortCriteria', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..aOS(1, 'tag')
    ..e<SortCriteria_Order>(2, 'order', $pb.PbFieldType.OE, defaultOrMaker: SortCriteria_Order.ASC, valueOf: SortCriteria_Order.valueOf, enumValues: SortCriteria_Order.values)
    ..hasRequiredFields = false
  ;

  SortCriteria._() : super();
  factory SortCriteria() => create();
  factory SortCriteria.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SortCriteria.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<SortCriteria> createRepeated() => $pb.PbList<SortCriteria>();
  @$core.pragma('dart2js:noInline')
  static SortCriteria getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SortCriteria>(create);
...
class Sorting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Sorting', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..pc<SortCriteria>(1, 'criterias', $pb.PbFieldType.PM, subBuilder: SortCriteria.create)
    ..hasRequiredFields = false
  ;
...
class FieldSelection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FieldSelection', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..m<$core.String, Field>(1, 'fields', entryClassName: 'FieldSelection.FieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Field.create, packageName: const $pb.PackageName('infoblox.api'))
    ..hasRequiredFields = false
  ;

  FieldSelection._() : super();
  factory FieldSelection() => create();
  factory FieldSelection.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FieldSelection.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<FieldSelection> createRepeated() => $pb.PbList<FieldSelection>();
  @$core.pragma('dart2js:noInline')
  static FieldSelection getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FieldSelection>(create);
...
class Field extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Field', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..m<$core.String, Field>(2, 'subs', entryClassName: 'Field.SubsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Field.create, packageName: const $pb.PackageName('infoblox.api'))
    ..hasRequiredFields = false
  ;
...
class Filtering extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Filtering', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6])
    ..aOM<LogicalOperator>(1, 'operator', subBuilder: LogicalOperator.create)
    ..aOM<StringCondition>(2, 'stringCondition', subBuilder: StringCondition.create)
    ..aOM<NumberCondition>(3, 'numberCondition', subBuilder: NumberCondition.create)
    ..aOM<NullCondition>(4, 'nullCondition', subBuilder: NullCondition.create)
    ..aOM<StringArrayCondition>(5, 'stringArrayCondition', subBuilder: StringArrayCondition.create)
    ..aOM<NumberArrayCondition>(6, 'numberArrayCondition', subBuilder: NumberArrayCondition.create)
    ..hasRequiredFields = false
  ;

  Filtering._() : super();
  factory Filtering() => create();
  factory Filtering.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Filtering.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  @$core.pragma('dart2js:noInline')
  static Filtering getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Filtering>(create);
...
class LogicalOperator extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, LogicalOperator_Left> _LogicalOperator_LeftByTag = {
  ...
  static const $core.Map<$core.int, LogicalOperator_Right> _LogicalOperator_RightByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LogicalOperator', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 11, 12])
    ..oo(1, [5, 6, 7, 8, 13, 14])
    ..aOM<LogicalOperator>(1, 'leftOperator', subBuilder: LogicalOperator.create)
    ..aOM<StringCondition>(2, 'leftStringCondition', subBuilder: StringCondition.create)
    ..aOM<NumberCondition>(3, 'leftNumberCondition', subBuilder: NumberCondition.create)
    ..aOM<NullCondition>(4, 'leftNullCondition', subBuilder: NullCondition.create)
    ..aOM<LogicalOperator>(5, 'rightOperator', subBuilder: LogicalOperator.create)
    ..aOM<StringCondition>(6, 'rightStringCondition', subBuilder: StringCondition.create)
    ..aOM<NumberCondition>(7, 'rightNumberCondition', subBuilder: NumberCondition.create)
    ..aOM<NullCondition>(8, 'rightNullCondition', subBuilder: NullCondition.create)
    ..e<LogicalOperator_Type>(9, 'type', $pb.PbFieldType.OE, defaultOrMaker: LogicalOperator_Type.AND, valueOf: LogicalOperator_Type.valueOf, enumValues: LogicalOperator_Type.values)
    ..aOB(10, 'isNegative')
    ..aOM<StringArrayCondition>(11, 'leftStringArrayCondition', subBuilder: StringArrayCondition.create)
    ..aOM<NumberArrayCondition>(12, 'leftNumberArrayCondition', subBuilder: NumberArrayCondition.create)
    ..aOM<StringArrayCondition>(13, 'rightStringArrayCondition', subBuilder: StringArrayCondition.create)
    ..aOM<NumberArrayCondition>(14, 'rightNumberArrayCondition', subBuilder: NumberArrayCondition.create)
    ..hasRequiredFields = false
  ;

  LogicalOperator._() : super();
  factory LogicalOperator() => create();
  factory LogicalOperator.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LogicalOperator.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<LogicalOperator> createRepeated() => $pb.PbList<LogicalOperator>();
  @$core.pragma('dart2js:noInline')
  static LogicalOperator getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LogicalOperator>(create);
  ...
  @$pb.TagNumber(10)
  set isNegative($core.bool v) { $_setBool(9, v); }
  @$pb.TagNumber(10)
...
class StringCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StringCondition', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..pPS(1, 'fieldPath')
    ..aOS(2, 'value')
    ..e<StringCondition_Type>(3, 'type', $pb.PbFieldType.OE, defaultOrMaker: StringCondition_Type.EQ, valueOf: StringCondition_Type.valueOf, enumValues: StringCondition_Type.values)
    ..aOB(4, 'isNegative')
    ..hasRequiredFields = false
  ;
  ...
  factory StringCondition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StringCondition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<StringCondition> createRepeated() => $pb.PbList<StringCondition>();
  @$core.pragma('dart2js:noInline')
  static StringCondition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StringCondition>(create);
...
class NumberCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NumberCondition', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..pPS(1, 'fieldPath')
    ..a<$core.double>(2, 'value', $pb.PbFieldType.OD)
    ..e<NumberCondition_Type>(3, 'type', $pb.PbFieldType.OE, defaultOrMaker: NumberCondition_Type.EQ, valueOf: NumberCondition_Type.valueOf, enumValues: NumberCondition_Type.values)
    ..aOB(4, 'isNegative')
    ..hasRequiredFields = false
  ;
  ...
  factory NumberCondition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NumberCondition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<NumberCondition> createRepeated() => $pb.PbList<NumberCondition>();
  @$core.pragma('dart2js:noInline')
  static NumberCondition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NumberCondition>(create);
...
class NullCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NullCondition', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..pPS(1, 'fieldPath')
    ..aOB(2, 'isNegative')
    ..hasRequiredFields = false
  ;
  ...
  factory NullCondition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NullCondition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<NullCondition> createRepeated() => $pb.PbList<NullCondition>();
  @$core.pragma('dart2js:noInline')
  static NullCondition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NullCondition>(create);
  ...
  @$pb.TagNumber(2)
  set isNegative($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
...
class StringArrayCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StringArrayCondition', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..pPS(1, 'fieldPath')
    ..pPS(2, 'values')
    ..e<StringArrayCondition_Type>(3, 'type', $pb.PbFieldType.OE, defaultOrMaker: StringArrayCondition_Type.IN, valueOf: StringArrayCondition_Type.valueOf, enumValues: StringArrayCondition_Type.values)
    ..aOB(4, 'isNegative')
    ..hasRequiredFields = false
  ;
  ...
  factory StringArrayCondition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StringArrayCondition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  StringArrayCondition clone() => StringArrayCondition()..mergeFromMessage(this);
  ...
  static $pb.PbList<StringArrayCondition> createRepeated() => $pb.PbList<StringArrayCondition>();
  @$core.pragma('dart2js:noInline')
  static StringArrayCondition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StringArrayCondition>(create);
...
class NumberArrayCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NumberArrayCondition', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..pPS(1, 'fieldPath')
    ..p<$core.double>(2, 'values', $pb.PbFieldType.PD)
    ..e<NumberArrayCondition_Type>(3, 'type', $pb.PbFieldType.OE, defaultOrMaker: NumberArrayCondition_Type.IN, valueOf: NumberArrayCondition_Type.valueOf, enumValues: NumberArrayCondition_Type.values)
    ..aOB(4, 'isNegative')
    ..hasRequiredFields = false
  ;
  ...
  factory NumberArrayCondition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NumberArrayCondition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  NumberArrayCondition clone() => NumberArrayCondition()..mergeFromMessage(this);
  ...
  static $pb.PbList<NumberArrayCondition> createRepeated() => $pb.PbList<NumberArrayCondition>();
  @$core.pragma('dart2js:noInline')
  static NumberArrayCondition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NumberArrayCondition>(create);
...
class Pagination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Pagination', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..aOS(1, 'pageToken')
...
class PageInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PageInfo', package: const $pb.PackageName('infoblox.api'), createEmptyInstance: create)
    ..aOS(1, 'pageToken')
