...
class Identifier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Identifier', package: const $pb.PackageName('atlas.rpc'), createEmptyInstance: create)
  ...
  Identifier copyWith(void Function(Identifier) updates) => super.copyWith((message) => updates(message as Identifier));
